  ...
  return (
    <div className={styles.cartContainer}>
      ...
      {/* <div className={styles.emptyCartContainer}>
                ...
                <img src={emptyCartImg} alt="empty cart image" className={styles.emptyCartImg}/>
      ...
      <div className={styles.filledCartContainer}>
        ...
        <div className={styles.promotionalCode}>
          ...
          <input type="text" name="promo" className={styles.promoCode} placeholder="Promotional code" />
        </div>
